...
class CosineEasingSchedule(Schedule):
    ...
    def get(self, step):
        ...
        return self.initial_value + scale * 0.5 * (1 + math.cos(jnp.pi * x + jnp.pi))
...
class StepSchedule(Schedule):
    ...
    def __init__(
        self, initial_value, decay_interval, decay_factor, max_decays, final_value=None
    ):
        super().__init__()
        self.initial_value = initial_value
...
class PiecewiseSchedule(Schedule):
    ...
    def __init__(self, schedules: Iterable[Tuple[int, Union[Schedule, Iterable[Any]]]]):
