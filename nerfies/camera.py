...
class Camera:
    ...
    def pixels_to_rays(self, pixels: jnp.ndarray) -> Tuple[jnp.ndarray, jnp.ndarray]:
    ...
    def project(self, points: jnp.ndarray):
        ...
        y = (
            y * distortion
            + 2.0 * self.tangential_distortion[1] * x_times_y
        ...
        pixel_y = (
            self.focal_length * self.pixel_aspect_ratio * y + self.principal_point_y
        )
